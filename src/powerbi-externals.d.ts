...
declare namespace Parchment {
    interface ParchmentStatic {
        ...
        create(input: Node | string | Scope): Blot;
        ...
        // TODO Add these blots as needed
    ...
    interface ParchmentError extends Error {
        message: string;
        name: string;
        stack: string;
    }

    interface ParchmentErrorStatic {
        new (message: string): ParchmentError;
    }
    ...
    interface ClassAttributor extends Attributor {

    }

    interface ClassAttributorStatic extends Attributor {
        new (attrName: string, keyName: string, options?: Object): ClassAttributor
        keys(node: HTMLElement): string[];
    }

    interface StyleAttributor extends Attributor {

    }

    interface StyleAttributorStatic extends Attributor {
        new (attrName: string, keyName: string, options?: Object): StyleAttributor
        keys(node: HTMLElement): string[];
    }
    ...
    interface LinkedList<T extends LinkedNode> {
        append(...nodes: T[]): void;
    ...
    interface LinkedListStatic<T extends LinkedNode> {
        new: LinkedList<T>;
    }
    ...
    interface AttributorStoreStatic {
        new (domNode: HTMLElement): AttributorStore;
    }

    interface AttributorStatic {
        new (attrName: string, keyName: string, options?: Object): Attributor;
    }
}
/// <reference path="../parchment/parchment.d.ts" />
...
declare namespace quill {
    ...
    interface QuillStatic {
        new (container: string): Quill;
        new (container: string, options?: ConfigOptions): Quill;
        new (container: HTMLElement): Quill;
        new (container: HTMLElement, options?: ConfigOptions): Quill;
        debug(level: 'error' | 'warn' | 'log' | 'info' | true | false): void;
        import(path: string): any;
        register(path: string, def: any, overwrite?: boolean): void;
        register(defs: { [path: string]: any }, overwrite?: boolean): void;
    }

    interface Quill {
        container: HTMLElement;
        root: HTMLElement;
        scroll: Parchment.Parent;

        // Content
        deleteText(index: number, length: number): void;
        deleteText(index: number, length: number, source: Source): void;
        deleteText(range: Range): void;
        deleteText(range: Range, source: Source): void;
        getContents(): Delta;
        ...
        insertEmbed(index: number, type: string, url: string, source: Source): void;
        insertText(index: number, text: string): void;
        insertText(index: number, text: string, source: Source): void;
        insertText(index: number, text: string, name: string, value: string): void;
        insertText(index: number, text: string, name: string, value: string, source: Source): void;
        insertText(index: number, text: string, formats: FormatAttributes): void;
        insertText(index: number, text: string, formats: FormatAttributes, source: Source): void;
        pasteHTML(html: string): void;
        pasteHTML(html: string, source: Source): void;
        pasteHTML(index: number, html: string): void;
        pasteHTML(index: number, html: string, source: Source): void;
        setContents(delta: Delta | Op[]): void;
        setText(text: string): void;
        updateContents(delta: Delta | Op[]): void;

        // Formatting
        format(name: string, value: string): void;
        format(name: string, value: string, source: Source): void;
        format(name: string, value: boolean): void;
        format(name: string, value: boolean, source: Source): void;
        formatLine(index: number, length: number): void;
        formatLine(index: number, length: number, source: Source): void;
        formatLine(range: Range): void;
        formatLine(range: Range, source: Source): void;
        formatLine(index: number, length: number, name: string, value: string): void;
        formatLine(index: number, length: number, name: string, value: string, source: Source): void;
        formatLine(index: number, length: number, name: string, value: boolean): void;
        formatLine(index: number, length: number, name: string, value: boolean, source: Source): void;
        formatLine(range: Range, name: string, value: string): void;
        formatLine(range: Range, name: string, value: string, source: Source): void;
        formatLine(range: Range, name: string, value: boolean): void;
        formatLine(range: Range, name: string, value: boolean, source: Source): void;
        formatLine(index: number, length: number, formats: FormatAttributes): void;
        formatLine(index: number, length: number, formats: FormatAttributes, source: Source): void;
        formatLine(range: Range, formats: FormatAttributes): void;
        formatLine(range: Range, formats: FormatAttributes, source: Source): void;
        formatText(index: number, length: number): void;
        formatText(index: number, length: number, source: Source): void;
        formatText(range: Range): void;
        formatText(range: Range, source: Source): void;
        formatText(index: number, length: number, name: string, value: string): void;
        formatText(index: number, length: number, name: string, value: string, source: Source): void;
        formatText(index: number, length: number, name: string, value: boolean): void;
        formatText(index: number, length: number, name: string, value: boolean, source: Source): void;
        formatText(range: Range, name: string, value: string): void;
        formatText(range: Range, name: string, value: string, source: Source): void;
        formatText(range: Range, name: string, value: boolean): void;
        formatText(range: Range, name: string, value: boolean, source: Source): void;
        formatText(index: number, length: number, formats: FormatAttributes): void;
        formatText(index: number, length: number, formats: FormatAttributes, source: Source): void;
        formatText(range: Range, formats: FormatAttributes): void;
        formatText(range: Range, formats: FormatAttributes, source: Source): void;
        getFormat(): FormatAttributes;
        getFormat(index: number): FormatAttributes;
        getFormat(index: number, length: number): FormatAttributes;
        removeFormat(index: number, length: number): void;
        removeFormat(index: number, length: number, source: Source): void;
        removeFormat(range: Range): void;
        removeFormat(range: Range, source: Source): void;

        // Selection
        blur(): void;
        focus(): void;
        getBounds(index: number): Bounds;
        ...
        off(name: string, listener: TextChangeHandler): void;
        off(name: string, listener: SelectionChangeHandler): void;
        on(name: string, listener: TextChangeHandler): void;
        on(name: string, listener: SelectionChangeHandler): void;
    }

    interface TextChangeHandler {
        (delta: Delta, oldDelta: Delta, source: Source): void;
    }

    interface SelectionChangeHandler {
        (range: Range, oldRange: Range, source: Source): void;
    }
    ...
    interface RangeStatic {
        new (index: number, length?: number): Range;
    }
    ...
    **********/
    ...
    interface LoDashStatic {
        ...
        **/
        ...
        sortBy<T, TSort>(
            collection: Dictionary<T>,
            iteratee?: ObjectIterator<T, TSort>,
            thisArg?: any
        ): T[];
    ...
    interface LoDashObjectWrapper<T> {
        ...
        **/
        debounce(
            wait: number,
            options?: DebounceSettings): LoDashObjectWrapper<Function & Cancelable>;
    }
...
declare module D3 {
    ...
    export interface Base extends Selectors {
        ...
        */
        ease: (type: string, ...arrs: any[]) => (t: number) => number;
        /**
        ...
        */
        ...
        timer: {
            (funct: (elapsed: number) => boolean, delay?: number, mark?: number): void;
            flush(): void;
        }
    ...
    export interface Selection extends Selectors, Array<any> {
        attr: {
            ...
            (name: string, valueFunction: (this: Element, data: any, index: number) => any): Selection;
        ...
        style: {
            ...
            (name: string, valueFunction: (this: Element, data: any, index: number) => any, priority?: string): Selection;
        ...
        text: {
            (): string;
            (value: any): Selection;
            (valueFunction: (this: Element, data: any, index: number) => any): Selection;
        };
        ...
        data: {
            (values: (this: Element, data: any, index?: number) => any[], key?: (this: Element, data: any, index?: number) => any): UpdateSelection;
            (values: any[], key?: (this: Element, data: any, index?: number) => any): UpdateSelection;
            (): any[];
        };

        datum: {
            (values: (this: Element, data: any, index: number) => any): UpdateSelection;
            (values: any): UpdateSelection;
            (): any;
        };

        filter: {
            (filter: (this: Element, data: any, index: number) => boolean, thisArg?: any): UpdateSelection;
            (filter: string): UpdateSelection;
        };

        call(callback: (this: Element, selection: Selection, ...args: any[]) => void, ...args: any[]): Selection;
        each(eachFunction: (this: Element, data: any, index: number) => any): Selection;
        foo(func: (this: Element) => void): void;
        on: {
            (type: string): (this: Element, data: any, index: number) => any;
            (type: string, listener: (this: Element, data: any, index: number) => any, capture?: boolean): Selection;
        };
    ...
    export interface EnterSelection {
        ...
        empty: () => boolean;
        node: () => Element;
        call: (callback: (this: Element, selection: EnterSelection) => void) => EnterSelection;
        size: () => number;
    }
    ...
    export module Transition {
        export interface Transition {
            duration: {
                ...
                (duration: (this: Element, data: any, index: number) => any): Transition;
            };
            delay: {
                (delay: number): Transition;
                (delay: (this: Element, data: any, index: number) => any): Transition;
            };
            attr: {
                (name: string): string;
                (name: string, value: any): Transition;
                (name: string, valueFunction: (this: Element, data: any, index: number) => any): Transition;
                (attrValueMap: any): Transition;
            };
            style: {
                (name: string): string;
                (name: string, value: any, priority?: string): Transition;
                (name: string, valueFunction: (this: Element, data: any, index: number) => any, priority?: string): Transition;
                (styleValueMap: Object): Transition;
            };
            call(callback: (this: Element, selection: Selection) => void): Transition;
            call(callback: (this: Element, selection: any, anything: any) => void, ...arguments: any[]): Transition;
            /**
            * Select an element from the current document
            */
            select: {
            ...
            */
            ...
            each: (type?: string, eachFunction?: (this: Element, data: any, index: number) => any) => Transition;
            transition: () => Transition;
            ease: (value: string, ...arrs: any[]) => Transition;
            attrTween(name: string, tween: (this: Element, d: any, i: number, a: any) => BaseInterpolate): Transition;
            styleTween(name: string, tween: (this: Element, d: any, i: number, a: any) => BaseInterpolate, priority?: string): Transition;
            text: {
                (text: string): Transition;
                (text: (this: Element, d: any, i: number) => string): Transition;
            }
            tween(name: string, factory: InterpolateFactory): Transition;
            filter: {
                (selector: string): Transition;
                (selector: (this: Element, data: any, index: number) => boolean): Transition;
            };
            remove(): Transition;
        }
